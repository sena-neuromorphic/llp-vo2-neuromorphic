...
#Figure 6 from the main article
...
#If you are using Google Colab, make sure to upload the file
#Experimental_Data_VO2.xlsx to the working directory before running the scripts.
#The file Experimental_Data_VO2.xlsx contains the experimental data 
#The file Chapter2_2003.pdf contains a detailed description of the
